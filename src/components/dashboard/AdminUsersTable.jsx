...
import { updateUserRole, banUserAction, unbanUserAction, deleteUserAction } from '@/lib/actions/users';
                    ...
                    <table className="w-full border-collapse text-left text-sm text-zinc-400">
                        ...
                        <tbody className="divide-y divide-zinc-800/60 bg-[#1e1e1e]">
                            {users.map((user) => {
                                ...
                                const userStatus = user.banned || user.status === 'Suspended' ? 'Suspended' : 'Active';
