...
console.log(company);
            ...
            <div className="max-w-3xl mx-auto bg-[#121214] border border-zinc-900 rounded-xl p-8 shadow-2xl">
                ...
                <div className="border-b border-zinc-800 pb-6 mb-8">
                    ...
                    <div className="mt-4 inline-flex items-center gap-2 bg-zinc-900/50 border border-zinc-800 rounded-lg px-3 py-1.5 text-xs text-zinc-400">
                        ...
                        Posting as: <span className="font-semibold text-zinc-300">{company?.name || 'No Company'}</span>
  ...
  company.status !== "Approved" && (
    <div className="mt-4 rounded-xl border border-yellow-300 bg-yellow-50 p-4 text-center shadow-sm">
      <h3 className="text-lg font-semibold text-yellow-700">
        Approval Pending
      </h3>
      <p className="mt-1 text-sm text-yellow-600">
        Please wait until your company gets approved.
      </p>
    </div>
  )
}
