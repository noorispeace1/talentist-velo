...
export default function CompanyProfile({ recruiter, recruiterCompany }) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (company?._id) {
            const payload = await updateCompany(company._id, newCompanyData);
            if (payload.modifiedCount > 0 || payload.matchedCount > 0 || payload.acknowledged) {
                setCompany({ ...newCompanyData, _id: company._id });
