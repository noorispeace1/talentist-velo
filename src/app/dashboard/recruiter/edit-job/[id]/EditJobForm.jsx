...
export default function EditJobForm({ jobData }) {
    const router = useRouter();
    const [isRemote, setIsRemote] = useState(jobData?.isRemote || false);
    ...
    const handleSubmit = async (e) => {
        ...
        const jobId = jobData._id?.$oid || jobData._id;
            ...
            <div className="max-w-3xl mx-auto bg-[#121214] border border-zinc-900 rounded-xl p-8 shadow-2xl">
                ...
                <div className="border-b border-zinc-800 pb-6 mb-8">
                    ...
                    <p className="text-zinc-400 text-sm mt-1">
                        Update the details for: <strong className="text-zinc-200">{jobData.jobTitle}</strong>
                    </p>
                </div>
                ...
                <Form onSubmit={handleSubmit} className="space-y-8" validationErrors={errors} validationBehavior='aria'>
                    ...
                    <Fieldset className="space-y-6 w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <TextField name="jobTitle" defaultValue={jobData.jobTitle} isInvalid={!!errors.jobTitle} className="flex flex-col gap-1 w-full">
                            ...
                            <Select className={selectBoxClass} name="jobCategory" defaultSelectedKeys={jobData.jobCategory ? [jobData.jobCategory] : []} isInvalid={!!errors.jobCategory}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Select className={selectBoxClass} name="jobType" defaultSelectedKeys={jobData.jobType ? [jobData.jobType] : []} isInvalid={!!errors.jobType}>
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                <div className="col-span-2 space-y-1">
                                    ...
                                    <div className="flex gap-2">
                                        <TextField name="minSalary" defaultValue={jobData.minSalary} isInvalid={!!errors.minSalary} className="w-full">
                                            <Input placeholder="Min" type="number" className={textInputClass} />
                                        </TextField>
                                        <TextField name="maxSalary" defaultValue={jobData.maxSalary} isInvalid={!!errors.maxSalary} className="w-full">
                                            <Input placeholder="Max" type="number" className={textInputClass} />
                                        </TextField>
                                    </div>
                                </div>

                                <Select className="w-full mt-6" name="currency" defaultSelectedKeys={[jobData.currency || "USD"]}>
                                    <Select.Trigger className={triggerClasses}>
                                        <Select.Value />
                                        <Select.Indicator />
                                    </Select.Trigger>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                            <div className="space-y-2">
                                ...
                                <TextField name="location" defaultValue={jobData.location} isInvalid={!isRemote && !!errors.location} className="flex flex-col gap-1 w-full relative">
                            ...
                            <TextField name="deadline" defaultValue={jobData.deadline} isInvalid={!!errors.deadline} className="flex flex-col gap-1 w-full">
                    ...
                    <Fieldset className="space-y-6 w-full">
                        ...
                        <TextField name="responsibilities" defaultValue={jobData.responsibilities} isInvalid={!!errors.responsibilities} className="flex flex-col gap-1 w-full">
                        ...
                        <TextField name="requirements" defaultValue={jobData.requirements} isInvalid={!!errors.requirements} className="flex flex-col gap-1 w-full">
                        ...
                        <TextField name="benefits" defaultValue={jobData.benefits} className="flex flex-col gap-1 w-full">
