...
export default function SignupPage() {
    ...
    const redirectTo = searchParams.get("redirect") || "/"; // Default to dashboard if no redirect specified
    // UI States
    ...
    const handleSignup = async (e) => {
        ...
        const plan = role === 'seeker' ? 'seeker_free' : 'recruiter_free'; // Assign default plan based on role
